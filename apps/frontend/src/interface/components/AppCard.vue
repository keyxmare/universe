...
const emit = defineEmits<{ (e: 'select', app: AppMeta): void }>();

function onSelect() {
  emit('select', props.app);
}
</script>
<style scoped>
.app-card {
...
.app-card h3 { margin: 0 0 .5rem; font-size: 1.1rem; }
.app-card p { margin: 0; font-size: .9rem; color: var(--card-muted); }
</style>
